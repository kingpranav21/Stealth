/** Default paths Stealth refuses to hydrate (disk + noise). */
export const DEFAULT_BLOAT_PATTERNS = [
  "**/node_modules/**",
  "**/.git/**",
  "**/dist/**",
  "**/build/**",
...
/** Pure check — pass patterns from editor config in the extension layer. */
export function matchesBloatPath(
  relativePath: string,
  patterns: string[] = DEFAULT_BLOAT_PATTERNS
): boolean {
